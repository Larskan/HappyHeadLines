...
public record DraftDto(Guid Id, Guid Author, string Title, string Body, DateTime CreatedAt, DateTime UpdatedAt);
public record DraftCreateDto(string Title, string Body, Guid AuthorId);
